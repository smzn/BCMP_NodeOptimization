...
class BCMP_GA_Class:
    ...
    def getFinalResult(self, individual):
        ...
        np.savetxt('./ga_L_'+str(self.N)+'_'+str(self.R)+'_'+str(self.K_total)+'_'+str(self.node_number)+'_'+str(self.npop)+'_'+str(self.ngen)+'_std.csv', L_class, delimiter=',')
        np.savetxt('./ga_Node_'+str(self.N)+'_'+str(self.R)+'_'+str(self.K_total)+'_'+str(self.node_number)+'_'+str(self.npop)+'_'+str(self.ngen)+'_std.csv', individual, delimiter=',')
        np.savetxt('./ga_P_'+str(self.N)+'_'+str(self.R)+'_'+str(self.K_total)+'_'+str(self.node_number)+'_'+str(self.npop)+'_'+str(self.ngen)+'_std.csv', p, delimiter=',')
        print('Final Result')
   ...
   #重力モデルで推移確率行列を作成 
    ...
    def getGraph(self):
        ...
        plt.grid()
        plt.legend()
        fig.savefig('./ga_transition_'+str(self.N)+'_'+str(self.R)+'_'+str(self.K_total)+'_'+str(self.node_number)+'_'+str(self.npop)+'_'+str(self.ngen)+'_std.png')
